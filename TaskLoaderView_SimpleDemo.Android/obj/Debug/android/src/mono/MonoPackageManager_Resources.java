...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "TaskLoaderView_SimpleDemo.Android.dll" comes first in this list. */
		"TaskLoaderView_SimpleDemo.Android.dll",
		"Sharpnado.TaskLoaderView.dll",
		"FormsViewGroup.dll",
		"Sharpnado.TaskMonitor.dll",
		"TaskLoaderView_SimpleDemo.dll",
